...
LATEST_RELEASE_URL="https://github.com/abilashraghuram/arrakis/releases/latest"
...
RELEASE_URL="https://github.com/abilashraghuram/arrakis/releases/download/$RELEASE_TAG"
...
display_version_info() {
  ...
  if [ -f "$version_file" ]; then
    ...
    print_message "https://github.com/abilashraghuram/arrakis/releases/latest"
  else
