...
Usage:
    from arrakis_callback import callback
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python arrakis_callback.py <method> [params_json]", file=sys.stderr)
        print("Example: python arrakis_callback.py get_time", file=sys.stderr)
        print("Example: python arrakis_callback.py process '{\"data\": \"hello\"}'", file=sys.stderr)
        sys.exit(1)
